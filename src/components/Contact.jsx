...
const Contact = () => {
  return (
    <div name='contact' className='w-full bg-[#ffffff] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/7d94aa2b-bbf7-4996-83a6-43d6efb0412e" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#3d3d3d] text-[#0a192f]'><br></br><br></br>Contact</p>
